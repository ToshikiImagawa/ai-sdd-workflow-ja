...
#### CONSTITUTION ↔ ドキュメントの整合性（憲章が存在する場合）

| チェック対象      | 確認内容                                 | 重要度 |
|:------------|:-------------------------------------|:----|
| **原則の準拠**   | 仕様書・設計書がプロジェクト原則に準拠しているか             | 高   |
| **開発標準の遵守** | 定義された開発標準（コード品質、テスト、セキュリティ等）を満たしているか | 中   |
| **技術スタック**  | 許可された技術スタックを使用しているか                  | 中   |
...
| チェック対象              | 結果                     | 件数    |
|:--------------------|:-----------------------|:------|
| CONSTITUTION ↔ docs | 🟢 準拠 / 🔴 違反 / ⬜ 憲章なし | {n} 件 |
| PRD ↔ spec          | 🟢 整合 / 🔴 不整合         | {n} 件 |
